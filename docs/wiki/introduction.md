...
COREBOUND: Starpath is a semi-cooperative survival race about crossing the universe with a damaged ark ship.

The ship must survive together, but only one player wins.

## Premise

Earth is gone. The ark has a few awake humans, a fleet of cryo sleepers, six MOTHER cards, and a navigation AI named MOTHER who can solve any problem faster than her crew can. Every shortcut spends a MOTHER card, and the more cards are spent, the more future cards demand real human hands.
...
Crew are the action economy. Gates are the sector spine. MOTHER is the shortcut and danger system. Chambers are optional long-term upgrades. The route survives only if players cooperate, but leadership belongs to the player with the strongest living loyal crew base at the Final Gate.
...
>
> Wake rewards give the Implementer new loyal crew. After Gate 1 and Gate 2, the players with fewer crew draft first from Cryo. After the Final Gate, count loyal crew. Most loyal crew wins.
