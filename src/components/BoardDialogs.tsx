...
import { getShipPartLabel, getWaterPairFuelAmount } from '../game/shipParts'
...
function lossContent(reason: GameLossReason) {
  if (reason === 'sector-stranded') {
    return {
      ...
      body: 'No reachable Mission or Ship Part Research remains, and the Gate cannot be passed with current resources.',
    }
  }
