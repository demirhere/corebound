...
//     Scraps on top.
// Tuning targets: avg ~25 Scraps earned/run, ~2% win rate vs the 225-Fuel
...
// Scraps instead of 1; winners buy a mix of Ship Parts and Crew Quarter Upgrades,
// which is what it takes to push through the S3=16 wall and the steep
// back-end ramp.
